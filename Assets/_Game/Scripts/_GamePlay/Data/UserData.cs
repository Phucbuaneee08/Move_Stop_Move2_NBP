...
public class UserData : ScriptableObject
{
    ...
    public const string Key_Player_Shield = "PlayerShield";
    ...
    public WeaponName playerWeapon;
    public HatName playerHat;
    public PantName playerPant;
    //public AccessoryType playerAccessory;
    public SkinType playerSkin;
    public ShieldName playerShield;
    ...
    public void OnInitData()
    {
        ...
        playerHat = GetEnumData(Key_Player_Hat, HatName.Arrow);
        playerPant = GetEnumData(Key_Player_Pant, PantName.Dabao);
        playerShield = GetEnumData(Key_Player_Shield, ShieldName.Khien);
